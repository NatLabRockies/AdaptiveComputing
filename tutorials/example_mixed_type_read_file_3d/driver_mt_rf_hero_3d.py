...
def driver_mt_rf_3d():
    ...
    ds_ops.use_hero = True

    # Perform the optimization
    import time
    t = time.time()
    my_dataset = DataSet(func_mt, params, ds_ops)
    # my_dataset.add_lhs_samples(0)
    ...
    my_dataset.add_bo_samples(20,surrogate,viz_ops=viz_ops)
    # my_dataset.add_bo_samples(5,surrogate,viz_ops=viz_ops)
    my_dataset.wait_for_workers(surrogate)
