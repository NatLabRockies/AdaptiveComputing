...
from tests.test_examples import output_validator
...
def test_acq_func_minimum_variance():
    ...
    #dataset.add_known_samples(0, 0, 0)
    dataset.add_known_samples(np.atleast_2d(np.array([0])), np.atleast_2d(np.array([0])), 0)
    dataset.add_known_samples(np.atleast_2d(np.array([1])), np.atleast_2d(np.array([1])), 0)
    dataset.add_known_samples(np.atleast_2d(np.array([3])), np.atleast_2d(np.array([1])), 0)
    dataset.add_known_samples(np.atleast_2d(np.array([4])), np.atleast_2d(np.array([0])), 0)
