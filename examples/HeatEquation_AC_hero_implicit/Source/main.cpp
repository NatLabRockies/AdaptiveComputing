...
int main (int argc, char* argv[])
{
    ...
    PyObject *ac_driver = PyObject_CallMethod(py_thermal_properties, "initialize_driver", nullptr);
...
void main_main (PyObject *ac_driver)
{
    ...
    Real dt = imFactor*cfl/(2.0*coeff*40);
    ...
    for (int n = 1; n <= nsteps; ++n)
    {
        ...
        advance(phi_old, phi_new, dt, geom, bc, ac_driver);
        time = time + dt;
