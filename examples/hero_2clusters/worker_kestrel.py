...
def hero_worker():
    ...
    while True:
        ...
        for current_task in ready_tasks:
            if current_task['metadata']['slurm_job_id']['kestrel'] == -1:
                ...
                current_task['metadata']['slurm_job_id']['kestrel'] = job_id
        ...
        for current_task in running_tasks:
            if current_task['metadata']['running']['kestrel'] == False:
                if current_task['metadata']['slurm_job_id']['kestrel'] != -1:
                    job_id = current_task['metadata']['slurm_job_id']['kestrel']
