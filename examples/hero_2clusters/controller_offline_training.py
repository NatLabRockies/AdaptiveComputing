...
if __name__ == '__main__':
    ...
    ac_driver.dataset.add_samples(np.array([[0.8],[0.81]]),None,0)
    # 2) add samples with specified x_data and y_data. No hero queueing used.
    ac_driver.dataset.add_samples_nohero(np.array([[1.987],[0.806],[1.641]]),np.array([[4.02],[2.15],[3.81]]),0)
    ...
    ac_driver.add_points(np.array([[1.3],[2.3]]),i_fidelity=0)
