...
def bayesian_1d_sf():
    ...
    plt.xlabel('x')
    plt.ylabel('y')
    plt.title('1D Surrogate with TF_MELT Mixture Density Network')
    plt.savefig('tfmelt_mdn_result.png', dpi=150, bbox_inches='tight')
    print("Plot saved as 'tfmelt_mdn_result.png'")
