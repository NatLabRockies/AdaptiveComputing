...
class Model:
    ...
    def queue_hero_sample(self,fidelity_level,x_eval_num,y_gpr=True,viz_ops=None,frame_id=None):
        from ac_common.static_sampling import queue_hero_sample
        queue_hero_sample(self,fidelity_level,x_eval_num,y_gpr,viz_ops,frame_id)
