...
class HeroDataset(DatasetBase):
    def __init__(self, params, machine_names, n_fidelity=1, blocking=False):
        ...
        self._hero_task_id = [np.empty([0,1], dtype=f'<U72')]*self.n_fidelity # _hero_task_id is a list of length n_fidelity. Each entry will be an n_samp[i_fl] x 1 np array
